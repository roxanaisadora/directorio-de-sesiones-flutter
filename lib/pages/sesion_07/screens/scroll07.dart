...
import 'package:sesion_03/pages/sesion_07/widgets/pantilla.dart';
import 'package:tiktoklikescroller/tiktoklikescroller.dart';


class ScrollScrean07 extends StatefulWidget {
  const ScrollScrean07({super.key});

  @override
  State<ScrollScrean07> createState() => _ScrollScrean07State();
}

class _ScrollScrean07State extends State<ScrollScrean07> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('las 7 maravillas'),
        centerTitle: true,
      ),
